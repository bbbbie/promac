...
export const ServicesDropdown = ({ label, className }: ServicesDropdownProps) => {
  const location = useLocation();
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                {/* RENDER CÁC CỘT */}
                <div className="flex" style={{ gap: "24px" }}> {/* Giảm khoảng cách cột (cũ 40px) */}
                  {displayColumns.map((col, index) => (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-[12px]"> {/* Giảm gap item */}
                        {col.items.map((item, idx) => (
                          <Link
                            key={idx}
                            to={item.path}
