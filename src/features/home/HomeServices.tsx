...
const MAIN_SERVICES = [
  {
    ...
    image: project2,
    features: ["Hộp quà, hộp sản phẩm", "Thùng carton màu", "Hộp custom theo thiết kế"],
  },
  {
  ...
  },
  {
    ...
    image: project3,
    features: ["Catalogue, Brochure", "Namecard, Phong bì", "Kẹp file, Tiêu đề thư"],
  },
];
                ...
                <div className="flex flex-col gap-3 mb-6">
                  {service.features.map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-3">
                      <Check size={20} className="text-[#FF0000] shrink-0" strokeWidth={3} />
